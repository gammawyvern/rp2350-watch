...
warmup_rect = Rect(x=WARMUP_X, y=100, width=BAR_WIDTH, height=20, fill=WARMUP_COLOR)
focus_rect = Rect(x=FOCUS_X, y=100, width=BAR_WIDTH, height=20, fill=FOCUS_COLOR)
break_rect = Rect(x=BREAK_X, y=100, width=BAR_WIDTH, height=20, fill=BREAK_COLOR)
